...
const MainSegmentGroup = (0, _styledComponents.default)(_semanticUiReact.Segment.Group)({
  background: '#e3fcfc'
});
exports.MainSegmentGroup = MainSegmentGroup;
const DaySegment = (0, _styledComponents.default)(_semanticUiReact.Segment)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n   max-height: 20px;\n   font-size: 10px !important;\n   padding: 2px !important;\n   &:hover {\n      background-color: ", " !important;\n   }\n"])), props => darkerColor(props.backcolor, 20));
exports.DaySegment = DaySegment;
const ScrollableSegment = (0, _styledComponents.default)(_semanticUiReact.Segment)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n   overflow: auto;\n   max-height: ", "px;\n   padding: ", ";\n"])), props => props.height, props => props.nopadding ? '0!important' : '');
...
const SizedSegment = (0, _styledComponents.default)(_semanticUiReact.Segment)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n   overflow: auto;\n   padding: ", ";\n   ", "\n   margin: ", ";\n   background-color: ", " !important;\n   &:hover {\n      background-color: ", " ", ";\n   }\n   ", "\n"])), props => props.nopadding ? '0!important' : '', props => props.height > 0 ? "height: ".concat(props.height, "px;") : '', props => props.nomargin ? '0!important' : '', props => props.backcolor, props => darkerColor(props.backcolor, 10), props => props.nohover ? '' : '!important', props => props.border ? 'border: 1px solid rgba(34, 36, 38, 0.15) !important;' : '');
exports.SizedSegment = SizedSegment;
const PaddingLessGridColumn = (0, _styledComponents.default)(_semanticUiReact.Grid.Column)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n   padding-left: ", ";\n   padding-right: ", ";\n"])), props => props.paddingleft ? '' : '0px!important', props => props.paddingright ? '' : '0px!important');
exports.PaddingLessGridColumn = PaddingLessGridColumn;
const PaddingLessTableCell = (0, _styledComponents.default)(_semanticUiReact.Table.Cell)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n   padding: 0px !important;\n"])));
exports.PaddingLessTableCell = PaddingLessTableCell;
const SizedTableRow = (0, _styledComponents.default)(_semanticUiReact.Table.Row)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n   height: ", "px;\n"])), props => props.height);
exports.SizedTableRow = SizedTableRow;
const ColorButton = (0, _styledComponents.default)(_semanticUiReact.Button)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n   background-color: ", " !important;\n   &:hover {\n      background-color: ", " !important;\n   }\n"])), props => props.backcolor, props => darkerColor(props.backcolor, 10));
exports.ColorButton = ColorButton;
const CustomLabel = (0, _styledComponents.default)(_semanticUiReact.Label)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n   background-color: ", " !important;\n   font-size: 10px !important;\n   padding: 7px 4px !important;\n   width: ", "% !important;\n   margin-left: ", "% !important;\n"])), props => props.backcolor, props => props.width ? props.width : 100, props => props.margleft ? props.margleft : 0);
exports.CustomLabel = CustomLabel;
const MonthListItem = (0, _styledComponents.default)(_semanticUiReact.List.Item)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n   padding: 4px 0 !important;\n   height: 18px !important;\n"])));
exports.MonthListItem = MonthListItem;
const MargedIcon = (0, _styledComponents.default)(_semanticUiReact.Icon)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n   margin-left: ", "px !important;\n   margin-right: ", "px !important;\n"])), props => props.margleft ? props.margleft : 0, props => props.margright ? props.margright : 0);
exports.MargedIcon = MargedIcon;
const BiggerTimePicker = (0, _styledComponents.default)(_rcTimePicker.default)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n   .rc-time-picker-input {\n      height: 40px;\n      font-size: 20px;\n   }\n"])));
